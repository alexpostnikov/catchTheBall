...
class ur10svh(ur10SvhBase):
    ...
    def init_ora(self):  # ora -> observation reward actions
        ...
        self.action_mean = np.array([*np.ones(6) * 0.0,
                                     0.495015,0.499975,0.495017,0.720014,0.489975,0.289998,0.544970,0.679961,0.749934,0.144991,0.545005,0.680005,0.745026,0.444983,0.675012,0.710007,0.150016,0.445015,0.669938,0.730021])

        self.action_std = np.array([*np.ones(6) * 3.14 * 2,
                                    0.285803,0.288670,0.285809,0.415702,0.282898,0.167437,0.314654,0.392574,0.433002,0.083712,0.314663,0.392606,0.430101,0.256933,0.389686,0.409913,0.086600,0.256927,0.386817,0.421456])
